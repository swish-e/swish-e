...
=item -X  (extended header output)

The C<-X> switch generates extened I<header> output.  This is most useful when searching more than one
...
Even when searching a single index file, C<-X> will provided additional information about the index file,
