...
SWISH-E version 2 represents a major rewrite of the code and the addition of many new features.
...
distributions will include all that's needed.  At least mine does...
...
The SWISH-E documentation is in POD format, and the documentation can be found in the F<pod>
directory.  POD documentation is displayed by
...
=head2 What's included in the SWISH-E distribution?
...
This documentation is updated frequently from CVS at http://swishe.sourceforge.net/
