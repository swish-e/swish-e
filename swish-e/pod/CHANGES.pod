...
Here's a summary of the way swish works for the different versions.
    ...
    2.2.0 - Results are merged and fist N results are returned.
            e.g. Maxhits=20; 15 hits Index1, 40 hits Index2
...
Provides a way to do incremental indexing.  You pass C<-N> a path to a file
and only files newer than the last modified date of that file will be indexed.
