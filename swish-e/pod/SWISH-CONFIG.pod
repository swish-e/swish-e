...
L<IgnoreMeta|/"item_IgnoreMeta"> *list of names*
...
=item IgnoreMetaNames *list of names*

C<IgnoreMetaNames> defines a list of metanames to ignore while indexing.  This is useful to avoid indexing
...
This is solved by:    
    ...
    IgnoreMetanames updated_date

Warning: Any data listed in C<IgnoreMetanames> will not be indexed.  
