...
Note: If you are using the C<prog> input method (C<-S prog>), you will likely see better performance
by including the filtering within your C<prog> method program.  Keep this in mind if indexing speed is
critical.
