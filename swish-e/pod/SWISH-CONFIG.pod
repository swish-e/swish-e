...
L<StoreDescription|/StoreDescription> [XML <tag>|HTML <meta>|TXT size]
...
L<SwishSearchDefaultRule|/SwishSearchDefaultRule>   [<AND-WORD>|<or-word>]

=item *

L<SwishSearchOperators|/SwishSearchOperators> <and-word> <or-word> <not-word>
