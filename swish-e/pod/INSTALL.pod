...
You will probably want to specify options to the F<configure> script.
These options are described in detail below.  But, to be brief:

    ./configure --with-libxml2 --with-zlib
    make
    make test
    su root
    make install

You will need to be sure zlib and libxml2 are installed first.    
