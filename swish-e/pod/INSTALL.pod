...
SWISH-E has the -D, -v, and -k switches that may help resolve issues.
If possible find a single document that shows the problem, then index with -v 9 and watch
...
copy the file locally to make sure you can index the document locally.
