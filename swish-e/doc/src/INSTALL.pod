...
A C<configure> script is used to determine platform specific details for building swish.  Please contact
the SWISH-E discussion list if you notice any platform specify problems while building SWISH-E.
...
B<ask Stas for more info on the requirements.>    
