...
The B<MetaNames> directive is a space separated list:
...
This option should not be used in HTML documents.
...
SWISH-E calls the external program passing as arguments the file path
