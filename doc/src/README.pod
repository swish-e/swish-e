...
Optionally, you may view the documentation in HTML format in the html directory
of the distribution.  PDF or Postscript format is also available.
...
L<SWISH-INDEX|SWISH-RUN> -- Running Swish and Command Line Switches
