...
extern "C" {
#endif
extern SWINT_T porter_ISO_8859_1_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
static SWINT_T r_Step_5b(struct SN_env * z);
static SWINT_T r_Step_5a(struct SN_env * z);
...
static SWINT_T r_Step_1a(struct SN_env * z) {
    ...
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   SWINT_T ret = slice_from_s(z, 2, s_0); /* <-, line 26 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   SWINT_T ret = slice_from_s(z, 1, s_1); /* <-, line 27 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   SWINT_T ret = slice_del(z); /* delete, line 29 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static SWINT_T r_Step_1b(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 1:
            ...
            {   SWINT_T ret = slice_from_s(z, 2, s_2); /* <-, line 35 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   SWINT_T m_test = z->l - z->c; /* test, line 38 */
            ...
            {   SWINT_T ret = slice_del(z); /* delete, line 38 */
                if (ret < 0) return ret;
            }
            {   SWINT_T m_test = z->l - z->c; /* test, line 39 */
            ...
            switch(among_var) {
                ...
                case 1:
                    {   SWINT_T c_keep = z->c;
                        SWINT_T ret = insert_s(z, z->c, z->c, 1, s_3); /* <+, line 41 */
                        z->c = c_keep;
                        if (ret < 0) return ret;
                    }
                    break;
                case 2:
                    ...
                    z->c--; /* next, line 44 */
                    z->bra = z->c; /* ], line 44 */
                    {   SWINT_T ret = slice_del(z); /* delete, line 44 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 3:
                    if (z->c != z->I[0]) return 0; /* atmark, line 45 */
                    {   SWINT_T m_test = z->l - z->c; /* test, line 45 */
                    ...
                    {   SWINT_T c_keep = z->c;
                        SWINT_T ret = insert_s(z, z->c, z->c, 1, s_4); /* <+, line 45 */
                        z->c = c_keep;
                        if (ret < 0) return ret;
                    }
                    break;
...
static SWINT_T r_Step_1c(struct SN_env * z) {
    z->ket = z->c; /* [, line 52 */
    {   SWINT_T m1 = z->l - z->c; (void)m1; /* or, line 52 */
...
lab0:
    ...
    {   SWINT_T ret = slice_from_s(z, 1, s_7); /* <-, line 54 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
static SWINT_T r_Step_2(struct SN_env * z) {
    ...
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   SWINT_T ret = slice_from_s(z, 4, s_8); /* <-, line 59 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   SWINT_T ret = slice_from_s(z, 4, s_9); /* <-, line 60 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   SWINT_T ret = slice_from_s(z, 4, s_10); /* <-, line 61 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   SWINT_T ret = slice_from_s(z, 4, s_11); /* <-, line 62 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   SWINT_T ret = slice_from_s(z, 3, s_12); /* <-, line 63 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   SWINT_T ret = slice_from_s(z, 1, s_13); /* <-, line 64 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   SWINT_T ret = slice_from_s(z, 3, s_14); /* <-, line 66 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   SWINT_T ret = slice_from_s(z, 3, s_15); /* <-, line 68 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   SWINT_T ret = slice_from_s(z, 2, s_16); /* <-, line 69 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   SWINT_T ret = slice_from_s(z, 2, s_17); /* <-, line 71 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   SWINT_T ret = slice_from_s(z, 3, s_18); /* <-, line 72 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   SWINT_T ret = slice_from_s(z, 3, s_19); /* <-, line 74 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            {   SWINT_T ret = slice_from_s(z, 3, s_20); /* <-, line 76 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
            {   SWINT_T ret = slice_from_s(z, 3, s_21); /* <-, line 77 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static SWINT_T r_Step_3(struct SN_env * z) {
    ...
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   SWINT_T ret = slice_from_s(z, 2, s_22); /* <-, line 83 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   SWINT_T ret = slice_from_s(z, 2, s_23); /* <-, line 85 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   SWINT_T ret = slice_del(z); /* delete, line 87 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static SWINT_T r_Step_4(struct SN_env * z) {
    ...
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   SWINT_T ret = slice_del(z); /* delete, line 95 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   SWINT_T m1 = z->l - z->c; (void)m1; /* or, line 96 */
...
static SWINT_T r_Step_5a(struct SN_env * z) {
    ...
    z->bra = z->c; /* ], line 101 */
    {   SWINT_T m1 = z->l - z->c; (void)m1; /* or, line 102 */
        {   SWINT_T ret = r_R2(z);
    ...
    lab1:
        ...
        {   SWINT_T m2 = z->l - z->c; (void)m2; /* not, line 102 */
            {   SWINT_T ret = r_shortv(z);
...
lab0:
    {   SWINT_T ret = slice_del(z); /* delete, line 103 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
static SWINT_T r_Step_5b(struct SN_env * z) {
    ...
    {   SWINT_T ret = slice_del(z); /* delete, line 109 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
extern SWINT_T porter_ISO_8859_1_stem(struct SN_env * z) {
    ...
    {   SWINT_T c1 = z->c; /* do, line 116 */
        z->bra = z->c; /* [, line 116 */
        if (!(eq_s(z, 1, s_29))) goto lab0;
        z->ket = z->c; /* ], line 116 */
        {   SWINT_T ret = slice_from_s(z, 1, s_30); /* <-, line 116 */
            if (ret < 0) return ret;
        }
    ...
    {   SWINT_T c2 = z->c; /* do, line 117 */
        while(1) { /* repeat, line 117 */
            ...
            {   SWINT_T ret = slice_from_s(z, 1, s_32); /* <-, line 117 */
                if (ret < 0) return ret;
            }
    ...
    {   SWINT_T m6 = z->l - z->c; (void)m6; /* do, line 127 */
    ...
    {   SWINT_T m7 = z->l - z->c; (void)m7; /* do, line 128 */
    ...
    {   SWINT_T m8 = z->l - z->c; (void)m8; /* do, line 129 */
    ...
    {   SWINT_T m9 = z->l - z->c; (void)m9; /* do, line 130 */
    ...
    {   SWINT_T m10 = z->l - z->c; (void)m10; /* do, line 131 */
    ...
    {   SWINT_T m11 = z->l - z->c; (void)m11; /* do, line 132 */
    ...
    {   SWINT_T m12 = z->l - z->c; (void)m12; /* do, line 133 */
        {   SWINT_T ret = r_Step_5a(z);
    ...
    {   SWINT_T m13 = z->l - z->c; (void)m13; /* do, line 134 */
        {   SWINT_T ret = r_Step_5b(z);
    ...
    {   SWINT_T c14 = z->c; /* do, line 137 */
        ...
        while(1) { /* repeat, line 137 */
            ...
            {   SWINT_T ret = slice_from_s(z, 1, s_34); /* <-, line 137 */
                if (ret < 0) return ret;
            }
            continue;
        lab14:
