...
extern "C" {
#endif
extern SWINT_T dutch_ISO_8859_1_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
static SWINT_T r_en_ending(struct SN_env * z);
static SWINT_T r_e_ending(struct SN_env * z);
...
static SWINT_T r_prelude(struct SN_env * z) {
    SWINT_T among_var;
    {   SWINT_T c_test = z->c; /* test, line 42 */
        while(1) { /* repeat, line 42 */
            ...
            switch(among_var) {
                case 0: goto lab0;
                case 1:
                    {   SWINT_T ret = slice_from_s(z, 1, s_0); /* <-, line 45 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 2:
                    {   SWINT_T ret = slice_from_s(z, 1, s_1); /* <-, line 47 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 3:
                    {   SWINT_T ret = slice_from_s(z, 1, s_2); /* <-, line 49 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 4:
                    {   SWINT_T ret = slice_from_s(z, 1, s_3); /* <-, line 51 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 5:
                    {   SWINT_T ret = slice_from_s(z, 1, s_4); /* <-, line 53 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 6:
    ...
    {   SWINT_T c_keep = z->c; /* try, line 57 */
        z->bra = z->c; /* [, line 57 */
        if (!(eq_s(z, 1, s_5))) { z->c = c_keep; goto lab1; }
        z->ket = z->c; /* ], line 57 */
        {   SWINT_T ret = slice_from_s(z, 1, s_6); /* <-, line 57 */
            if (ret < 0) return ret;
        }
    lab1:
        ;
    ...
    while(1) { /* repeat, line 58 */
        ...
        while(1) { /* goto, line 58 */
            ...
            z->bra = z->c; /* [, line 59 */
            {   SWINT_T c4 = z->c; /* or, line 59 */
                if (!(eq_s(z, 1, s_7))) goto lab5;
                z->ket = z->c; /* ], line 59 */
                if (in_grouping(z, g_v, 97, 232, 0)) goto lab5;
                {   SWINT_T ret = slice_from_s(z, 1, s_8); /* <-, line 59 */
                    if (ret < 0) return ret;
                }
                goto lab4;
            lab5:
                ...
                z->ket = z->c; /* ], line 60 */
                {   SWINT_T ret = slice_from_s(z, 1, s_10); /* <-, line 60 */
                    if (ret < 0) return ret;
                }
            }
        lab4:
...
static SWINT_T r_mark_regions(struct SN_env * z) {
    ...
    {    /* gopast */ /* grouping v, line 69 */
        SWINT_T ret = out_grouping(z, g_v, 97, 232, 1);
        if (ret < 0) return 0;
        z->c += ret;
    }
    {    /* gopast */ /* non v, line 69 */
        SWINT_T ret = in_grouping(z, g_v, 97, 232, 1);
        if (ret < 0) return 0;
        z->c += ret;
    }
...
static SWINT_T r_undouble(struct SN_env * z) {
    {   SWINT_T m_test = z->l - z->c; /* test, line 91 */
    ...
    z->c--; /* next, line 91 */
    z->bra = z->c; /* ], line 91 */
    {   SWINT_T ret = slice_del(z); /* delete, line 91 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
static SWINT_T r_e_ending(struct SN_env * z) {
    ...
    {   SWINT_T m_test = z->l - z->c; /* test, line 96 */
...
static SWINT_T r_en_ending(struct SN_env * z) {
    ...
    {   SWINT_T m1 = z->l - z->c; (void)m1; /* and, line 102 */
        if (out_grouping_b(z, g_v, 97, 232, 0)) return 0;
        z->c = z->l - m1;
    ...
    {   SWINT_T ret = slice_del(z); /* delete, line 102 */
        if (ret < 0) return ret;
    }
    {   SWINT_T ret = r_undouble(z);
...
static SWINT_T r_standard_suffix(struct SN_env * z) {
    SWINT_T among_var;
    {   SWINT_T m1 = z->l - z->c; (void)m1; /* do, line 107 */
        z->ket = z->c; /* [, line 108 */
        ...
        switch(among_var) {
            ...
            case 1:
                ...
                {   SWINT_T ret = slice_from_s(z, 4, s_15); /* <-, line 110 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   SWINT_T ret = r_en_ending(z);
            ...
            case 3:
                ...
                {   SWINT_T ret = slice_del(z); /* delete, line 116 */
                    if (ret < 0) return ret;
                }
                break;
        }
    ...
    {   SWINT_T m2 = z->l - z->c; (void)m2; /* do, line 120 */
        {   SWINT_T ret = r_e_ending(z);
    ...
    {   SWINT_T m3 = z->l - z->c; (void)m3; /* do, line 122 */
        z->ket = z->c; /* [, line 122 */
        ...
        {   SWINT_T m4 = z->l - z->c; (void)m4; /* not, line 122 */
    ...
    {   SWINT_T m5 = z->l - z->c; (void)m5; /* do, line 126 */
        z->ket = z->c; /* [, line 127 */
        ...
        switch(among_var) {
            ...
            case 1:
                ...
                {   SWINT_T m6 = z->l - z->c; (void)m6; /* or, line 130 */
                    z->ket = z->c; /* [, line 130 */
                    ...
                    {   SWINT_T m7 = z->l - z->c; (void)m7; /* not, line 130 */
                        if (!(eq_s_b(z, 1, s_20))) goto lab7;
                        goto lab6;
                    lab7:
                        z->c = z->l - m7;
                    }
                    {   SWINT_T ret = slice_del(z); /* delete, line 130 */
                        if (ret < 0) return ret;
                    }
                    goto lab5;
                lab6:
            ...
            case 2:
                ...
                {   SWINT_T m8 = z->l - z->c; (void)m8; /* not, line 133 */
    ...
    {   SWINT_T m9 = z->l - z->c; (void)m9; /* do, line 146 */
        if (out_grouping_b(z, g_v_I, 73, 232, 0)) goto lab9;
        {   SWINT_T m_test = z->l - z->c; /* test, line 148 */
...
extern SWINT_T dutch_ISO_8859_1_stem(struct SN_env * z) {
    ...
    {   SWINT_T m3 = z->l - z->c; (void)m3; /* do, line 162 */
