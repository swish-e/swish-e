...
=head2 Version 2.4.7 - xxx

=over 4

=item Added RankScheme 2 for raw rank score

RankScheme == 2 will return the rank score unscaled. It uses the IDF/TF
ranking algorithm internally (same as RankScheme 1).
