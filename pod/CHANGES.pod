...
=head2 Version 2.4.8 - xxx

=over 4

=item example/templates/search.tt fix for escaped slashes

Per http://swish-e.org/archive/2008-06/12180.html

=item index format changed to use all 64-bit sizes

A global change was made to normalize index sizes for 64 bits.

B<This requires reindexing if you are upgrading from a previous version.>

=item fixed integer overflow issues
