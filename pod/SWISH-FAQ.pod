...
=head2 So, is SWISH-E a I<search engine>?
...
=head2 Are there binary distributions avaliable for Swish-e on platform foo?
...
=head2 Eh, but I just want to know how to index PDF doucments!
...
tell swish that you are indexing XML files for the PDF extenstion.
